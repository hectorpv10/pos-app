...
Este proyecto forma parte de la asignatura Proyecto Aplicado. Para su desarrollo se utilizó React junto con Vite en el frontend, y Firebase como solución para la base de datos y la implementación de funciones serverless.

Como framework de estilos se empleó Material UI (MUI), realizando algunas adaptaciones y personalizaciones sobre los lineamientos originales de Material Design, con el objetivo de ajustarlos mejor a los requerimientos y la estética del proyecto.
